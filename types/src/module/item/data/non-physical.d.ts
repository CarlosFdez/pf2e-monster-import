...
export declare type NonPhysicalItemType = 'action' | 'ancestry' | 'background' | 'class' | 'condition' | 'effect' | 'feat' | 'kit' | 'lore' | 'martial' | 'melee' | 'spell' | 'spellcastingEntry';
...
export declare class BaseNonPhysicalItemData<TItem extends ItemPF2e = ItemPF2e> extends BaseItemDataPF2e<TItem> {
    readonly isPhysical: false;
}
export interface BaseNonPhysicalItemData<TItem extends ItemPF2e = ItemPF2e> extends Omit<BaseNonPhysicalItemSource, 'effects'> {
