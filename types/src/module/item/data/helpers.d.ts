...
export declare function isMagicItemData(itemData: ItemSourcePF2e): itemData is MagicItemSource;
export declare function isMagicItemData(itemData: ItemDataPF2e): itemData is MagicItemData;
export declare function isMagicItemData(itemData: ItemSourcePF2e | ItemDataPF2e): itemData is MagicItemSource | MagicItemData;
