...
export declare type ProficiencyRank = 'untrained' | 'trained' | 'expert' | 'master' | 'legendary';
...
export declare type PhysicalItemData = ArmorData | ConsumableData | ContainerData | EquipmentData | TreasureData | WeaponData;
export declare type MagicItemData = Exclude<PhysicalItemData, TreasureData>;
export declare type MagicItemSource = Exclude<PhysicalItemSource, TreasureSource>;
export declare type ItemDataPF2e = PhysicalItemData | ActionData | AncestryData | BackgroundData | ClassData | ConditionData | EffectData | FeatData | KitData | LoreData | MartialData | MeleeData | SpellcastingEntryData | SpellData;
...
export type { ArmorData, ConsumableData, ContainerData, EquipmentData, TreasureData, WeaponData, ActionData, AncestryData, BackgroundData, ClassData, ConditionData, EffectData, FeatData, KitData, LoreData, MeleeData, SpellcastingEntryData, SpellData, };
export { ArmorSource, ConsumableSource, ContainerSource, EquipmentSource, TreasureSource, WeaponSource, ActionSource, AncestrySource, BackgroundSource, ClassSource, ConditionSource, EffectSource, FeatSource, KitSource, LoreSource, MeleeSource, SpellcastingEntrySource, SpellSource, };
