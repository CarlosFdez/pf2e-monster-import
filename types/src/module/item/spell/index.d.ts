...
export declare class SpellPF2e extends ItemPF2e {
    ...
    getChatData(this: Embedded<SpellPF2e>, htmlOptions?: EnrichHTMLOptions, rollOptions?: {
        ...
        traditions: import("../../data").ValuesList<"arcane" | "divine" | "occult" | "primal">;
        school: {
            value: "abjuration" | "conjuration" | "divination" | "enchantment" | "evocation" | "illusion" | "necromancy" | "transmutation";
        };
        components: {
            value: string;
        };
