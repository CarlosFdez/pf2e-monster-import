...
export declare function adjustDegreeOfSuccess(adjustment: DegreeAdjustment, degreeOfSuccess: DegreeOfSuccess): DegreeOfSuccess;
/**
 * @param dieValue rolled number on the die
 * @param degreeOfSuccess current success value
 */
export declare function adjustDegreeByDieValue(dieValue: number, degreeOfSuccess: DegreeOfSuccess): DegreeOfSuccess;
