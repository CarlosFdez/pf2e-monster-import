...
export declare class CheckPF2e {
     ...
     */
    static roll(check: StatisticModifier, context?: CheckModifiersContext, event?: JQuery.Event, callback?: (roll: Rolled<Roll>) => void): void;
...
export declare class DamageRollPF2e {
     ...
     * @param callback
     */
    static roll(damage: DamageTemplate, context: any, _event: JQuery.Event | undefined, callback?: Function): void;
}
export {};
