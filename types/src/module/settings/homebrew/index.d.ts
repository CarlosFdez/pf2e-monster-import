...
export interface HomebrewTag<T extends ConfigPF2eHomebrewList = ConfigPF2eHomebrewList> {
    id: T extends 'baseWeapons' ? BaseWeaponType : T extends Exclude<ConfigPF2eHomebrewList, 'baseWeapons'> ? keyof ConfigPF2e['PF2E'][T] : never;
    value: string;
}
export declare class HomebrewElements extends SettingsMenuPF2e {
    ...
    protected _updateObject(_event: Event, data: Record<ConfigPF2eHomebrewList, HomebrewTag[]>): Promise<void>;
