...
export declare class LootPF2e extends ActorPF2e {
    ...
    protected _onCreate(data: LootSource, options: DocumentModificationContext, userId: string): void;
    protected _onUpdate(changed: DeepPartial<this['data']['_source']>, options: DocumentModificationContext, userId: string): void;
    protected _onCreateEmbeddedDocuments(embeddedName: 'ActiveEffect' | 'Item', documents: ActiveEffectPF2e[] | ItemPF2e[], result: foundry.data.ActiveEffectSource[] | ItemSourcePF2e[], options: DocumentModificationContext, userId: string): void;
    protected _onDeleteEmbeddedDocuments(embeddedName: 'ActiveEffect' | 'Item', documents: ActiveEffectPF2e[] | ItemPF2e[], result: foundry.data.ActiveEffectSource[] | ItemSourcePF2e[], options: DocumentModificationContext, userId: string): void;
}
