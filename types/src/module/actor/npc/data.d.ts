...
export declare type NPCStrike = StatisticModifier & RawNPCStrike;
/** Normal armor class data, but with an additional 'base' value. */
declare type NPCArmorClassData = ArmorClassData & {
    base?: number;
};
/** Normal save data, but with an additional 'base' value. */
declare type NPCSaveData = SaveData & {
    base?: number;
    saveDetail: string;
};
...
declare type NPCPerceptionData = PerceptionData & {
    base?: number;
};
