...
export declare function createActionMacro(actionIndex: string, actorId: string, slot: number): Promise<void>;
...
export declare function createToggleEffectMacro(pack: string, effect: EffectPF2e, slot: number): Promise<void>;
